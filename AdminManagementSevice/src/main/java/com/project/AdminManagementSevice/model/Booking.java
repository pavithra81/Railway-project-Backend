...
public class Booking {
    ...
    @ApiModelProperty(notes = "The unique Train Id.")
    ...
    @ApiModelProperty(notes = "The unique Passenger Id which is autogenerated.")
    ...
    @Pattern(regexp = "^\\d{2}-\\d{2}-\\d{4}$", message = "Only digits are allowed for date in the format dd-mm-yyyy")
    @ApiModelProperty(notes = "The journey date")
