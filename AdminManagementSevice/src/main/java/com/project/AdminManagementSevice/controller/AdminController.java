...
import com.project.AdminManagementSevice.service.*;
...
public class AdminController {
 ...
 @PostMapping("/add")
    @ApiOperation(value = " Register Admin Details ",
            notes = "Provide the Admin Details")
    public Admin add(@Valid @RequestBody Admin admin) {
